...
class WorkSchedule
{
     ...
     * @param \TheClinic\DataStructures\Time\DSWorkSchedule $dsWorkSchedule
     * @return void
     */
    public function movePointerToClosestWorkSchedule(\DateTime &$pointer, DSWorkSchedule $dsWorkSchedule): void
    {
        ...
        /** @var \TheClinic\DataStructures\Time\DSTimePeriods $periods */
        foreach ($newDSWorkSchedule as $weekDay => $periods) {
            /** @var \TheClinic\DataStructures\Time\DSTimePeriod $period */
